...
std::vector<uint8_t> AESEncrypt(std::vector<uint8_t> plaintext, std::vector<uint8_t> key)
{
	int i;
...
//	for (i = 0; i < Nk * 4; i++)
//	{
//		printbincharpad(in[i]);
//	}

//	printf("\n\n Key in bin:\n");
//	for (i = 0; i < Nk * 4; i++)
//	{
//		printbincharpad(Key[i]);
//	}
...
//	printf("\nText after encryption in hex:\n");
//	for(i=0;i<Nk*4;i++)
//	{
//		printf("%02x ",out[i]);
//	}

//	printf("\nText after encryption in bin:\n");
//	for (i = 0; i < Nk * 4; i++)
//	{
//		printbincharpad(out[i]);
//	}
